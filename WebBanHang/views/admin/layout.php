...
<head>
  ...
  <title>Bán Linh Kiện Máy Tính - Admin</title>
  <link rel="shortcut icon" href="./assetsuser/image/logo.png" type="image/png" />
    ...
    <aside class="left-sidebar">
      <div class="logo-img">
        <a href="./admin.php?controller=product&action=index ">
          <img src="./assetsuser/image/banner.png" alt="Logo">
        </a>
      </div>
